...
- **Data Ingestion Agent** — file validation, cleaning, profiling  
- **ETL & Data Quality Agent** — dataset merging, anomaly handling  
- **Exploratory Analysis Agent** — automated EDA  
- **Statistical Testing Agent** — hypothesis testing  
- **Predictive Analysis Agent** — forecasting  
- **Insight Synthesis Agent** — business‑ready insights  
